...
const questions: Record<string, string> = {
  ...
  behavioral_12: 'Tell us about an interaction, value, or facet of Product Space that resonates with you the most and explain why.',
  ...
  behavioral_24: 'If you could design a social for Product Space this semester, what would it be, and why?',
  behavioral_25: 'Rate the applicant’s passion for Product Space and its values.',
  ...
  behavioral_28: 'Rate this applicant as an overall fit into Product Space, both technically and culturally.',
}
...
export function behavioralQuestion(key: string, fallback: string, role?: string | null): string {
  if (key === 'behavioral_10') {
    ...
    return 'What can Product Space’s curriculum track or community provide that you can’t get from courses, internships, or projects?'
  }
